GuiScreen = {}
    ...
    GuiScreen["objectives_page_Group"] = {
	    ["geOrder"] = 11,
	    ["hidden_FrameBox"] = {
...
--
    GuiScreen["multiscore_page_Group"] = {
