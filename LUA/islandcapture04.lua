...
function luaStageInit()
	CreateScript("luaInitIslandCapture04")
end

function luaInitIslandCapture04(this)
	Mission = this
	Mission.Name = "IslandCapture04"
-- logolasok
--	DamageLog = true
--	Mission.HelperLog = true
	Mission.CustomLog = true
	SETLOG(this, true)
-- RELEASE_LOGOFF  	Log("Initiating IslandCapture04")
	-- Loc-Kit dolgok
...
-- RELEASE_LOGOFF  		luaLog("Initiating Island Capture Mode 4v4")
		...
		table.insert(Mission.Shipyards, FindEntity("Shipyard Entity CB2"))
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		SetGuiName(Mission.CP5, "globals.unitclass_commandpost|".." - |13")
		Mission.CP6 = FindEntity("CP06 H")
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |14")
		Mission.CP7 = FindEntity("CP07 H")
		SetGuiName(Mission.CP7, "globals.unitclass_commandpost|".." - |18")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 1 Params")
		...
		SetCommandBuildingOwnerPlayer(Mission.CB2, PLAYER_6)
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 6 Params")
		...
		SetGuiName(Mission.CB7, "globals.unitclass_headquarter|".." - |11")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 8 Params")
		...
		SetGuiName(Mission.CB9, "globals.unitclass_headquarter|".." - |15")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 10 Params")
		...
		SetCommandBuildingOwnerPlayer(Mission.CB11, PLAYER_2)
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP1 = FindEntity("CP01 L")
		SetGuiName(Mission.CP1, "globals.unitclass_commandpost|".." - |02")
		Mission.CP2 = FindEntity("CP02 L")
		SetGuiName(Mission.CP2, "globals.unitclass_commandpost|".." - |03")
		Mission.CP3 = FindEntity("CP03 L")
		SetGuiName(Mission.CP3, "globals.unitclass_commandpost|".." - |07")
		Mission.CP4 = FindEntity("CP04 L")
		SetGuiName(Mission.CP4, "globals.unitclass_commandpost|".." - |09")
		Mission.CP5 = FindEntity("CP05 L")
		SetGuiName(Mission.CP5, "globals.unitclass_commandpost|".." - |13")
		...
		Mission.CB1 = FindEntity("CB1")
		Mission.CB1.CaptureWeight = 3
		Mission.CB1.StrategicGain = 5
		SetGuiName(Mission.CB1, "globals.unitclass_headquarter|".." - |01")
		Mission.CB2 = FindEntity("CB2")
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP5 = FindEntity("CP05 M")
		SetGuiName(Mission.CP5, "globals.unitclass_commandpost|".." - |08")
		Mission.CP6 = FindEntity("CP06 M")
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |09")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 7 Params")
		...
		SetGuiName(Mission.CB8, "globals.unitclass_headquarter|".." - |07")
		Mission.CB9 = FindEntity("CB9")
		Mission.CB9.CaptureWeight = 2
		Mission.CB9.StrategicGain = 7
		SetCommandBuildingOwnerPlayer(Mission.CB9, PLAYER_5)
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 9 Params")
		SetGuiName(Mission.CB9, "globals.unitclass_headquarter|".." - |10")
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CB7.CaptureWeight = 4
		Mission.CB7.StrategicGain = 7
		SetGuiName(Mission.CB7, "globals.unitclass_headquarter|".." - |02")
-- RELEASE_LOGOFF  		luaLog("")
		Mission.CB8 = FindEntity("CB8")
		Mission.CB8.CaptureWeight = 2
		Mission.CB8.StrategicGain = 4
...
-- korulmenyek beallitasa
    ...
    SetThink(this, "luaIslandCapture04_think")
...
-------------------------				THINK				---------------------------------------------
-----------------------------------------------------------------------------------------
function luaIslandCapture04_think(this, msg)
...
function luaSetObjectives()
	if Mission.IC4v4 == true then
		...
		-- allied objs
		luaObj_Add("primary", 1, {Mission.CB1, Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB6, Mission.CB7, Mission.CB8, Mission.CB9, Mission.CB10, Mission.CB11})
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.CB1, Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB6, Mission.CB7, Mission.CB8, Mission.CB9, Mission.CB10, Mission.CB11})
...
function luaShowMissionHint()
	ShowHint("ID_Hint_IslandCapture04")
