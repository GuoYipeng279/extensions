---- BATTLE OF THE SURIGAO STRAIT (BSM CLASSIC) ----
...
function luaInit(this)
	...
	this.Name = "Classic6"..dateandtime
	...
	this.Objectives = {
		["primary"] = {
			[1] = {
				["Party"] = PARTY_ALLIED,
				["ID"] = "us_obj_pri1",
				["Text"] = "Destroy the Japanese Battleships!",
				["TextCompleted"] = "The Japanese Battleships have been destroyed!",
				["Active"] = false,
				["Success"] = nil,
				["Target"] = {},
			...
			[2] = {
				...
				["ID"] = "jap_obj_pri1",
				["Text"] = "Break through the enemy force to Leyte Gulf!",
				["TextFailed"] = "The Japanese force has broken through!",
				["Active"] = false,
				["Success"] = nil,
				["Target"] = {},
				["ScoreCompleted"] = 500,	-- teljesitesert jaro pontszam,
			...
			[3] = {
				["Party"] = PARTY_ALLIED,
				["ID"] = "us_obj_pri2",
				["Text"] = "Protect your key units!",
				["TextFailed"] = "Our key units have been destroyed!",
				["Active"] = false,
				["Success"] = nil,
				["Target"] = {},
				["ScoreCompleted"] = 500,	-- teljesitesert jaro pontszam,
			...
			[4] = {
				["Party"] = PARTY_JAPANESE,
				["ID"] = "jap_obj_pri2",
				["Text"] = "Protect your battleships!",
				["TextFailed"] = "Our battleships have been destroyed!",
				["Active"] = false,
				["Success"] = nil,
				["Target"] = {},
				["ScoreCompleted"] = 500,	-- teljesitesert jaro pontszam,
	...
	Mission.Fuso = FindEntity("Fuso")
	Mission.Yamashiro = FindEntity("Yamashiro")
	
	Mission.TargetPoint = {}
		Mission.TargetPoint.x = -8685
		Mission.TargetPoint.y = 0
		Mission.TargetPoint.z = -140
	
	Mission.IJNGang = {}
		table.insert(Mission.IJNGang, FindEntity("Fuso"))
		table.insert(Mission.IJNGang, FindEntity("Yamashiro"))
		table.insert(Mission.IJNGang, FindEntity("Mikuma"))
		...
		table.insert(Mission.IJNGang, FindEntity("Shirakumo"))
	...
	Mission.IJNCVGang = {}
		table.insert(Mission.IJNCVGang, FindEntity("Fuso"))
		table.insert(Mission.IJNCVGang, FindEntity("Yamashiro"))
		--table.insert(Mission.IJNCVGang, Mission.TargetPoint)
	...
	Mission.USNGang = {}
		table.insert(Mission.USNGang, FindEntity("AirField"))
		table.insert(Mission.USNGang, FindEntity("Shipyard 1"))
		table.insert(Mission.USNGang, FindEntity("Shipyard 2"))
		table.insert(Mission.USNGang, FindEntity("Renown"))
		table.insert(Mission.USNGang, FindEntity("Repulse"))
		table.insert(Mission.USNGang, FindEntity("Oakland"))
		table.insert(Mission.USNGang, FindEntity("Juneau"))
		table.insert(Mission.USNGang, FindEntity("Fletcher"))
		table.insert(Mission.USNGang, FindEntity("Morris"))
		table.insert(Mission.USNGang, FindEntity("Pope"))
		table.insert(Mission.USNGang, FindEntity("Sands"))
	...
	for idx,unit in pairs(Mission.USNGang) do
		...
		if not unit.Class.Type == "AirField" or not unit.Class.Type == "Shipyard" then
	...
	Mission.USNCVGang = {}
		table.insert(Mission.USNCVGang, FindEntity("AirField"))
		table.insert(Mission.USNCVGang, FindEntity("Shipyard 1"))
		table.insert(Mission.USNCVGang, FindEntity("Shipyard 2"))
		table.insert(Mission.USNCVGang, FindEntity("Renown"))
		table.insert(Mission.USNCVGang, FindEntity("Repulse"))
		table.insert(Mission.USNCVGang, FindEntity("Oakland"))
		table.insert(Mission.USNCVGang, FindEntity("Juneau"))
...
function luaThink(this, msg)
	...
	elseif Mission.Started then
		...
		DisplayScores(1, 0, "Destroy the Japanese battleships!", "Japanese battleships left:".."| #MultiScore.0.1#")
		DisplayScores(1, 1, "Destroy the Japanese battleships!", "Japanese battleships left:".."| #MultiScore.1.1#")
		DisplayScores(1, 2, "Destroy the Japanese battleships!", "Japanese battleships left:".."| #MultiScore.2.1#")
		DisplayScores(1, 3, "Destroy the Japanese battleships!", "Japanese battleships left:".."| #MultiScore.3.1#")
		DisplayScores(1, 4, "Break through the enemy force to Leyte Gulf!", "Allied key units left:".."| #MultiScore.4.1#")
		DisplayScores(1, 5, "Break through the enemy force to Leyte Gulf!", "Allied key units left:".."| #MultiScore.5.1#")
		DisplayScores(1, 6, "Break through the enemy force to Leyte Gulf!", "Allied key units left:".."| #MultiScore.6.1#")
		DisplayScores(1, 7, "Break through the enemy force to Leyte Gulf!", "Allied key units left:".."| #MultiScore.7.1#")
		
		if not Mission.Fuso.Dead and luaGetDistance(Mission.Fuso, Mission.TargetPoint) < 500 then
		
			luaEndMission(true)
		
		elseif not Mission.Yamashiro.Dead and luaGetDistance(Mission.Yamashiro, Mission.TargetPoint) < 500 then
...
function luaStartMission()
	...
	luaObj_AddUnit("primary", 2, Mission.TargetPoint)
