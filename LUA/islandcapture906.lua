...
-- RELEASE_LOGOFF  		luaLog("Initiating Island Capture Mode 3v3")
	...
	Mission.Hermes = FindEntity("Hermes")
	...
	Mission.Shipyards = {}
		table.insert(Mission.Shipyards, FindEntity("US Shipyard"))
		table.insert(Mission.Shipyards, FindEntity("IJN Shipyard"))		
		table.insert(Mission.Shipyards, FindEntity("HQ 05 Shipyard"))
		table.insert(Mission.Shipyards, FindEntity("HQ 06 Shipyard"))
		table.insert(Mission.Shipyards, FindEntity("HQ 07 Shipyard"))
		table.insert(Mission.Shipyards, FindEntity("HQ 08 Shipyard"))
		...
		Mission.JPCB = {}
			...
			table.insert(Mission.JPCB, Mission.Zuiho)
			table.insert(Mission.JPCB, Mission.Zuikaku)
			table.insert(Mission.JPCB, Mission.Akagi)
...
-- korulmenyek beallitasa
	...
	SetThink(this, "luaIslandCapture906_think")	
...
-------------------------				THINK				---------------------------------------------
-----------------------------------------------------------------------------------------
function luaIslandCapture906_think(this, msg)
...
function luaSetObjectives()	
	if Mission.IC3v3 == true then
		...
		-- allied objs
		luaObj_Add("primary", 1, {Mission.Hermes, Mission.Lexington, Mission.Essex, Mission.Zuiho, Mission.Zuikaku, Mission.Akagi, Mission.CB1, Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB6, Mission.CB7, Mission.CB8})
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.Hermes, Mission.Lexington, Mission.Essex, Mission.Zuiho, Mission.Zuikaku, Mission.Akagi, Mission.CB1, Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB6, Mission.CB7, Mission.CB8})
