...
Globals["LimboMinTime"] = 3

Globals["UnitCameraSpeedMul"] = 2.0
...
Globals["WeatherReconModifiers"] = -- latasi viszonyokhoz rendelt recon szorzok
{
	["Default"] = 1,
	["Clear"] = 1, -- tiszta ido
	["Misty"] = 0.8, -- paras
...
Globals["WarningScrollSpeeds"] =
{
	["actual"] = 0.001,
	["history"] = 0.0002,
} --WarningScrollSpeeds

Globals["WeaponSystems"] =
{
...
Globals["BlackoutDefaultTime"] = 1

Globals["TargetMarkers"] =
{
...
Globals["FOVs"] = -- degrees
{
	["Ship"] = 30,
	["Plane"] = 40,
}

Globals["UnitSellTime"] = 30
Globals["UnitSellTimeSingle"] = 5

Globals["MapUnitColors"] =
{
	["us"] = { 90, 200, 250, 255 },
	["usAI"] = { 4, 87, 128, 255 },
	["jap"] = { 240, 50, 50, 255 },
...
Globals["MapZoomTime"] = 0.25
Globals["MapGlobalScale"] = 0.7
Globals["SpawnAttemptDelay"] = 0.5
Globals["SpawnPlaneDelayRange"] = 150
Globals["SpawnPlaneDelayDistance"] = 200
