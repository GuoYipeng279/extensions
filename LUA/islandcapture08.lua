...
function luaStageInit()
	CreateScript("luaInitIslandCapture08")
end

function luaInitIslandCapture08(this)
	Mission = this
	Mission.Name = "IslandCapture08"
-- logolasok
--	DamageLog = true
--	Mission.HelperLog = true
	Mission.CustomLog = true
	SETLOG(this, true)
-- RELEASE_LOGOFF  	Log("Initiating IslandCapture08")
	-- Loc-Kit dolgok
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		SetGuiName(Mission.CP7, "globals.unitclass_commandpost|".." - |09")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 1 Params")
		...
		SetGuiName(Mission.CB2, "globals.unitclass_headquarter|".." - |10")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 3 Params")
		...
		Mission.Yorktown = FindEntity("IC - Yorktown")
		SetParty(Mission.Yorktown, PARTY_ALLIED)
		SetRoleAvailable(Mission.Yorktown,EROLF_ALL,PLAYER_1)
-- RELEASE_LOGOFF  		luaLog("")
		Mission.Lexington = FindEntity("IC - Lexington")
		SetParty(Mission.Lexington , PARTY_ALLIED)
		SetRoleAvailable(Mission.Lexington ,EROLF_ALL,PLAYER_1)
-- RELEASE_LOGOFF  		luaLog("")
		Mission.Shokaku  = FindEntity("IC - Shokaku")
		SetParty(Mission.Shokaku, PARTY_JAPANESE)
		SetRoleAvailable(Mission.Shokaku,EROLF_ALL,PLAYER_5)
-- RELEASE_LOGOFF  		luaLog("")
		Mission.Zuikaku = FindEntity("IC - Zuikaku")
		SetParty(Mission.Zuikaku, PARTY_JAPANESE)
		SetRoleAvailable(Mission.Zuikaku,EROLF_ALL,PLAYER_5)
-- RELEASE_LOGOFF  		luaLog("")
	end
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP6 = FindEntity("CP06")
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |03")
		Mission.CP7 = FindEntity("CP07")
		SetGuiName(Mission.CP7, "globals.unitclass_commandpost|".." - |04")
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.Shokaku  = FindEntity("IC - Shokaku Small Medium")
		SetParty(Mission.Shokaku, PARTY_JAPANESE)
		SetRoleAvailable(Mission.Shokaku,EROLF_ALL,PLAYER_5)
-- RELEASE_LOGOFF  		luaLog("")
		Mission.Zuikaku = FindEntity("IC - Zuikaku Medium")
		SetParty(Mission.Zuikaku, PARTY_JAPANESE)
		SetRoleAvailable(Mission.Zuikaku,EROLF_ALL,PLAYER_5)
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.JPCB = {}
			...
			table.insert(Mission.JPCB, Mission.Shokaku)
...
-- korulmenyek beallitasa
    ...
    SetThink(this, "luaIslandCapture08_think")
...
-------------------------				THINK				---------------------------------------------
-----------------------------------------------------------------------------------------
function luaIslandCapture08_think(this, msg)
...
function luaSetObjectives()
	if Mission.IC4v4 == true then
		...
		-- allied objs
		luaObj_Add("primary", 1, {Mission.CB1, Mission.CB2, Mission.CB3})
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.CB1, Mission.CB2, Mission.CB3})
	...
	if Mission.IC3v3 == true then
		...
		-- allied objs
		luaObj_Add("primary", 1, {Mission.CB2, Mission.CB3})
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.CB2, Mission.CB3})
		Mission.MissionInit = false
		end	
	end
	...
	if Mission.IC2v2 == true then
		...
		-- allied objs
		luaObj_Add("primary", 1, {Mission.CB1, Mission.CB3})
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.CB1, Mission.CB3})
		Mission.MissionInit = false
		end	
	end
...
function luaShowMissionHint()
	ShowHint("ID_Hint_IslandCapture08")
