...
function luaInit(this)
	...
	Mission = this
	Mission.ScriptFile = "Scripts/missions/IJN/ijn_sandbox.lua"

	this.Name = "AxisSandBox"
	...
	PilotMoveToRange(FindEntity("MoviePlane"), FindEntity("Kuma"))
	
	local trg1 = FindEntity("MoviePlane")
	
	local dist = 30
	
	if trg1.Class.Type == "LevelBomber" or trg1.Class.Type == "LargeReconPlane" then
	...
	luaIngameMovie(
	{
	  ...
	  {["postype"] = "cameraandtarget", ["target"] = trg1, ["distance"] = dist, ["theta"] = 16, ["rho"] = -30, ["moveTime"] = 0},
	  {["postype"] = "cameraandtarget", ["target"] = trg1, ["distance"] = dist, ["theta"] = 16, ["rho"] = -30, ["moveTime"] = 70},
	   
	}, luaStop, true)
	
	for i = 1, 3 do
	
		luaGenerateFishSchool({[1] = {["x"] = -20, ["y"] = 0, ["z"] = -20},  [2] = {["x"] = 20, ["y"] = 0, ["z"] = 20}}, 1)
...
function luaStop()
	...
	SetSelectedUnit(FindEntity("MoviePlane"))
