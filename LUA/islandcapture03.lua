...
function luaStageInit()
	CreateScript("luaInitIslandCapture03")
end

function luaInitIslandCapture03(this)
	Mission = this
	Mission.Name = "IslandCapture03"
-- logolasok
--	DamageLog = true
--	Mission.HelperLog = true
	Mission.CustomLog = true
	SETLOG(this, true)
-- RELEASE_LOGOFF  	Log("Initiating IslandCapture03")
	-- Loc-Kit dolgok
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP4 = FindEntity("CP04")
		SetGuiName(Mission.CP4, "globals.unitclass_commandpost|".." - |09")				
		Mission.CP5 = FindEntity("CP05")
		SetGuiName(Mission.CP5, "globals.unitclass_commandpost|".." - |12")
		Mission.CP6 = FindEntity("CP06")
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |13")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 4 Params")
		...
		SetGuiName(Mission.CB5, "globals.unitclass_headquarter|".." - |10")
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP4 = FindEntity("CP04")
		SetGuiName(Mission.CP4, "globals.unitclass_commandpost|".." - |06")						
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 4 Params")
		...
		Mission.CB5.CaptureWeight = 2
		Mission.CB5.StrategicGain = 7
		--SetCommandBuildingOwnerPlayer(Mission.CB5, PLAYER_3)
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 5 Params")
...
--			table.insert(Mission.CommandPosts, Mission.CP6)
		...
		Mission.CB7.StrategicGain = 7
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 7 Params")	
		SetGuiName(Mission.CB7, "globals.unitclass_headquarter|".." - |01")
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP3 = FindEntity("CP03")
		SetGuiName(Mission.CP3, "globals.unitclass_commandpost|".." - |03")
		Mission.CP4 = FindEntity("CP04")
...
-- korulmenyek beallitasa
    ...
    SetThink(this, "luaIslandCapture03_think")
...
-------------------------				THINK				---------------------------------------------
-----------------------------------------------------------------------------------------
function luaIslandCapture03_think(this, msg)
...
function luaSetObjectives()
	if Mission.IC4v4 == true then
		...
		-- allied objs
		luaObj_Add("primary", 1, {Mission.CB1, Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB6, Mission.CB7})
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.CB1, Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB6, Mission.CB7})
	...
	if Mission.IC3v3 == true then
		...
		-- allied objs
		luaObj_Add("primary", 1, {Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB7})
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB7})
		Mission.MissionInit = false
		end	
	end
	...
	if Mission.IC2v2 == true then
		...
		-- allied objs
		luaObj_Add("primary", 1, {Mission.CB3, Mission.CB4, Mission.CB7})
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.CB3, Mission.CB4, Mission.CB7})
		Mission.MissionInit = false
		end	
	end
	...
	if Mission.IC1v1 == true then
		...
		-- allied objs
		luaObj_Add("primary", 1, {Mission.CB3, Mission.CB4})
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.CB3, Mission.CB4})
		Mission.MissionInit = false
		end	
	end
end
...
function luaShowMissionHint()
	ShowHint("ID_Hint_IslandCapture03")
