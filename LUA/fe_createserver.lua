GuiScreen = {}
    ...
    GuiScreen["geOrder"] = 0
    GuiScreen["cs_popup_Group"] = {
	    ["Pos"] = { 0.500000, 0.500000, -600.000000 },
	    ["Size"] = { 0.500000, 0.500000 },
	    ["Pivot"] = { 0.500000, 0.500000 },
	    ["geOrder"] = 2,
	    ["connection_Text"] = {
		    ["Pos"] = { 0.013542, 0.219444, -2.000000 },
		    ["Size"] = { 0.161458, 0.083333 },
		    ["Color"] = { 0.894118, 0.800000, 0.596078, 1.000000 },
		    ["geOrder"] = 2,
		    ["Font"] = "Arial16",
		    ["Multiline"] = false,
		    ["DefaultText"] = "FE.multi_createconnection",
		    ["Align"] = "Left",
		    ["VerticalAlign"] = "Top",
		    ["DefaultShadow"] = 0,
		},
        ["Connection_Group"] = {
		    ["Pos"] = { 0.055542, 0.229444, -2.000000 },
        ...
        ["create_server_Text"] = {
		    ["Pos"] = { 0.251042, 0.443056, 0.000000 },
		    ...
		    ["Font"] = "Viper19",
		    ["Multiline"] = false,
		    ["DefaultText"] = "FE.multi_createserver",
		    ["Align"] = "Left",
		    ["VerticalAlign"] = "Top",
		    ["DefaultShadow"] = 0,
		},
        ["ingamemap_Group"] = {
		    ["Pos"] = { 0.281250, 0.250000, 0.000000 },
		    ["Size"] = { 0.500000, 0.500000 },
		    ["Pivot"] = { 0.500000, 0.500000 },
		    ["geOrder"] = 0,
		    ["connection_t_Text"] = {
			    ["Pos"] = { 0.166667, 0.218056, -2.000000 },
			    ["Size"] = { 0.276042, 0.083333 },
			    ["Color"] = { 0.894118, 0.800000, 0.596078, 1.000000 },
			    ["geOrder"] = 6,
			    ["Font"] = "Arial16",
			    ["Multiline"] = false,
			    ["DefaultText"] = "Ingame Map",
			    ["Align"] = "Left",
			    ["VerticalAlign"] = "Top",
			    ["DefaultShadow"] = 0,
			},
            ["popup_Listbox"] = {
			    ["Pos"] = { 0.164583, 0.259722, -2.000000 },
			    ["Size"] = { 0.272917, 0.277778 },
			    ["geOrder"] = 0,
			    ["MouseHit"] = true,
			    ["max_rank_Group"] = {
				    ["Pos"] = { 0.002084, 0.080556, 0.000000 },
				    ["Size"] = { 0.276042, 0.031944 },
				    ["geOrder"] = 3,
				    ["max_rank_t_Text"] = {
					    ["Pos"] = { 0.036458, 0.000000, 0.000000 },
					    ["Size"] = { 0.239583, 0.083333 },
					    ["Color"] = { 0.894118, 0.800000, 0.596078, 1.000000 },
					    ["geOrder"] = 0,
					    ["MouseHit"] = true,
					    ["Font"] = "Arial16",
                    ...
                    ["rank_Icon"] = {
					    ["Pos"] = { 0.000000, 0.016666, 0.000000 },
					    ["Size"] = { 0.031250, 0.027778 },
                ...
                ["min_rank_Group"] = {
				    ["Pos"] = { 0.002084, 0.054167, 0.000000 },
				    ["Size"] = { 0.276042, 0.031944 },
				    ["geOrder"] = 2,
				    ["min_rank_t_Text"] = {
					    ["Pos"] = { 0.036458, 0.000000, 0.000000 },
                ...
                ["players_t_Text"] = {
				    ["Pos"] = { 0.002084, -0.001389, 0.000000 },
				    ["Size"] = { 0.276042, 0.083333 },
				    ["Color"] = { 0.894118, 0.800000, 0.596078, 1.000000 },
				    ["geOrder"] = 1,
				    ["MouseHit"] = true,
                ...
                ["private_t_Text"] = {
				    ["Pos"] = { 0.002084, 0.025000, 0.000000 },
				    ["Size"] = { 0.276042, 0.083333 },
				    ["Color"] = { 0.894118, 0.800000, 0.596078, 1.000000 },
				    ["geOrder"] = 0,
				    ["MouseHit"] = true,
            ...
            ["scroll_left_Icon"] = {
			    ["Pos"] = { 0.153646, 0.275695, -2.000000 },
			    ...
			    ["States"] = {
				    [1] = {
					    ["Texture"] = "common\\arrows\\arrow_left.tga",
					},
                    [2] = {
					    ["Texture"] = "common\\arrows\\arrow_left_mouse.tga",
					},
                    [3] = {
					    ["Texture"] = "common\\arrows\\arrow_left_on.tga",
					}
				}
			},
            ["scroll_right_Icon"] = {
			    ["Pos"] = { 0.455730, 0.275695, -2.000000 },
			    ["Size"] = { 0.015625, 0.020833 },
			    ["Pivot"] = { 0.500000, 0.500000 },
			    ["geOrder"] = 3,
			    ["MouseHit"] = true,
			    ["States"] = {
				    [1] = {
					    ["Texture"] = "common\\arrows\\arrow_right.tga",
					},
                    [2] = {
					    ["Texture"] = "common\\arrows\\arrow_right_mouse.tga",
					},
                    [3] = {
					    ["Texture"] = "common\\arrows\\arrow_right_on.tga",
					}
				}
			},
            ["server_name_t_Text"] = {
			    ["Pos"] = { 0.166667, 0.191667, -2.000000 },
			    ["Size"] = { 0.276042, 0.083333 },
			    ["Color"] = { 0.894118, 0.800000, 0.596078, 1.000000 },
			    ["geOrder"] = 5,
			    ["Font"] = "Arial16",
        ...
        ["max_rank_Text"] = {
		    ["Pos"] = { 0.013542, 0.311111, -2.000000 },
		    ["Size"] = { 0.161458, 0.083333 },
		    ["Color"] = { 0.894118, 0.800000, 0.596078, 1.000000 },
		    ["geOrder"] = 7,
		    ["Font"] = "Arial16",
		    ["Multiline"] = false,
		    ["DefaultText"] = "FE.multi_createrankmin",
		    ["Align"] = "Left",
		    ["VerticalAlign"] = "Top",
		    ["DefaultShadow"] = 0,
		},
        ["min_rank_Text"] = {
		    ["Pos"] = { 0.013542, 0.338889, -2.000000 },
		    ["Size"] = { 0.161458, 0.083333 },
		    ["Color"] = { 0.894118, 0.800000, 0.596078, 1.000000 },
		    ["geOrder"] = 7,
		    ["Font"] = "Arial16",
		    ["Multiline"] = false,
		    ["DefaultText"] = "FE.multi_createrankmax",
		    ["Align"] = "Left",
		    ["VerticalAlign"] = "Top",
		    ["DefaultShadow"] = 0,
		},
        ["new_FrameBox"] = {
		    ["Pos"] = { 0.000000, 0.184722, 0.000000 },
		    ["Size"] = { 0.500000, 0.194444 },
		    ["geOrder"] = 4,
		    ["States"] = {
			    [1] = {
        ...
        ["players_Text"] = {
		    ["Pos"] = { 0.013542, 0.258333, -2.000000 },
		    ["Size"] = { 0.161458, 0.083333 },
		    ["Color"] = { 0.894118, 0.800000, 0.596078, 1.000000 },
		    ["geOrder"] = 6,
		    ["Font"] = "Arial16",
		    ["Multiline"] = false,
		    ["DefaultText"] = "FE.multi_createplayers",
		    ["Align"] = "Left",
		    ["VerticalAlign"] = "Top",
		    ["DefaultShadow"] = 0,
		},
        ["private_slot_Text"] = {
		    ["Pos"] = { 0.013542, 0.284722, -2.000000 },
		    ["Size"] = { 0.161458, 0.083333 },
		    ["Color"] = { 0.894118, 0.800000, 0.596078, 1.000000 },
		    ["geOrder"] = 7,
		    ["Font"] = "Arial16",
		    ["Multiline"] = false,
		    ["DefaultText"] = "FE.multi_createprivate",
		    ["Align"] = "Left",
		    ["VerticalAlign"] = "Top",
		    ["DefaultShadow"] = 0,
		},
        ["server_Name_Text"] = {
		    ["Pos"] = { 0.013542, 0.191667, -2.000000 },
		    ["Size"] = { 0.161458, 0.083333 },
		    ["Color"] = { 0.894118, 0.800000, 0.596078, 1.000000 },
		    ["geOrder"] = 5,
		    ["Font"] = "Arial16",
		    ["Multiline"] = false,
		    ["DefaultText"] = "FE.multi_createservername",
		    ["Align"] = "Left",
		    ["VerticalAlign"] = "Top",
		    ["DefaultShadow"] = 0,
		}
