...
function luaStageInit()
	CreateScript("luaInitIslandCapture05")
end

function luaInitIslandCapture05(this)
	Mission = this
	Mission.Name = "IslandCapture05"
-- logolasok
--	DamageLog = true
--	Mission.HelperLog = true
	Mission.CustomLog = true
	SETLOG(this, true)
-- RELEASE_LOGOFF  	Log("Initiating IslandCapture05")
	-- Loc-Kit dolgok
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP1 = FindEntity("CP01H")
		SetGuiName(Mission.CP1, "globals.unitclass_commandpost|".." - |05")
		
		Mission.CP2 = FindEntity("CP02H")
		SetGuiName(Mission.CP2, "globals.unitclass_commandpost|".." - |06")

		Mission.CP3 = FindEntity("CP03H")
		SetGuiName(Mission.CP3, "globals.unitclass_commandpost|".." - |08")
		
		Mission.CP4 = FindEntity("CP04H")
		SetGuiName(Mission.CP4, "globals.unitclass_commandpost|".." - |09")
		
		Mission.CP5 = FindEntity("CP05H")
		SetGuiName(Mission.CP5, "globals.unitclass_commandpost|".." - |10")

		Mission.CP6 = FindEntity("CP06H")
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |12")

		Mission.CP7 = FindEntity("CP07H")
		SetGuiName(Mission.CP7, "globals.unitclass_commandpost|".." - |14")

		Mission.CP8 = FindEntity("CP08")
		SetGuiName(Mission.CP8, "globals.unitclass_commandpost|".." - |17")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 1 Params")
		...
		--SetCommandBuildingOwnerPlayer(Mission.CB2, PLAYER_2)
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 2 Params")
		...
		--SetCommandBuildingOwnerPlayer(Mission.CB3, PLAYER_3)
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 4 Params")
		...
		SetGuiName(Mission.CB5, "globals.unitclass_headquarter|".." - |07")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 5 Params")
		...
		SetGuiName(Mission.CB6, "globals.unitclass_headquarter|".." - |11")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 6 Params")
		Mission.CB7 = FindEntity("CB7")
		--SetCommandBuildingOwnerPlayer(Mission.CB7, PLAYER_6)
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 7 Params")
		...
		--SetCommandBuildingOwnerPlayer(Mission.CB8, PLAYER_7)
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 8 Params")
		...
		--SetCommandBuildingOwnerPlayer(Mission.CB9, PLAYER_8)
		Mission.CB9.CaptureWeight = 2
		Mission.CB9.StrategicGain = 7
		SetGuiName(Mission.CB9, "globals.unitclass_headquarter|".." - |16")
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP1 = FindEntity("CP01L")
		SetGuiName(Mission.CP1, "globals.unitclass_commandpost|".." - |04")
		Mission.CP2 = FindEntity("CP02L")
		SetGuiName(Mission.CP2, "globals.unitclass_commandpost|".." - |05")
		Mission.CP3 = FindEntity("CP03L")
		...
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |11")
		Mission.CP7 = FindEntity("CP07L")
		SetGuiName(Mission.CP7, "globals.unitclass_commandpost|".." - |13")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 4 Params")
		...
		Mission.CB5.CaptureWeight = 2
		Mission.CB5.StrategicGain = 7
		SetGuiName(Mission.CB5, "globals.unitclass_headquarter|".." - |06")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 5 Params")
		Mission.CB6 = FindEntity("CB6")
		Mission.CB6.CaptureWeight = 2
		Mission.CB6.StrategicGain = 4
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 6 Params")
		...
		Mission.CB7.StrategicGain = 7
		SetCommandBuildingOwnerPlayer(Mission.CB7, PLAYER_5)
		SetGuiName(Mission.CB7, "globals.unitclass_headquarter|".." - |12")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 7 Params")
		Mission.CB8 = FindEntity("CB8")
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP2 = FindEntity("CP02M")
		SetGuiName(Mission.CP2, "globals.unitclass_commandpost|".." - |03")
		Mission.CP4 = FindEntity("CP04M")
...
-- korulmenyek beallitasa
    ...
    SetThink(this, "luaIslandCapture05_think")
...
-------------------------				THINK				---------------------------------------------
-----------------------------------------------------------------------------------------
function luaIslandCapture05_think(this, msg)
...
function luaSetObjectives()
	...
	if Mission.IC1v1 == true then
		...
		-- allied objs
		luaObj_Add("primary", 1, {Mission.CB2, Mission.CB3, Mission.CB4})
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.CB2, Mission.CB3, Mission.CB4})
		Mission.MissionInit = false
		end	
	end
end
...
function luaShowMissionHint()
	ShowHint("ID_Hint_IslandCapture05")
