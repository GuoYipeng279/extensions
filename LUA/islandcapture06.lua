...
-- RELEASE_LOGOFF  		luaLog("Setting Mission CapturePointLimit"..tostring(Mission.CapturePointLimit))
	...
	Mission.MissionTime = 0000					-- mennyi ido telt el a jatekidobol
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		SetGuiName(Mission.CP5, "globals.unitclass_commandpost|".." - |06")

		Mission.CP6 = FindEntity("CP06H")
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |07")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 2 Params")
		...
		--SetParty(Mission.CB3, PARTY_JAPANESE)d
		--SetRoleAvailable(Mission.CB3,EROLF_ALL,PLAYER_5)
		SetGuiName(Mission.CB3, "globals.unitclass_headquarter|".." - |07")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 3 Params")
		...
		SetGuiName(Mission.CB4, "globals.unitclass_headquarter|".." - |08")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 4 Params")
		...
		SetGuiName(Mission.CB5, "globals.unitclass_headquarter|".." - |12")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 5 Params")
		...
		Mission.CB6.CaptureWeight = 2
		Mission.CB6.StrategicGain = 4
		SetGuiName(Mission.CB6, "globals.unitclass_headquarter|".." - |08")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 6 Params")
		Mission.CB7 = FindEntity("CB7")
		Mission.CB7.CaptureWeight = 4
		Mission.CB7.StrategicGain = 7
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 8 Params")
		...
		Mission.CB9.CaptureWeight = 2
		Mission.CB9.StrategicGain = 7		
		SetGuiName(Mission.CB9, "globals.unitclass_headquarter|".." - |12")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 9 Params")
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		SetGuiName(Mission.CP4, "globals.unitclass_commandpost|".." - |01")
		Mission.CP5 = FindEntity("CP05M")
		SetGuiName(Mission.CP5, "globals.unitclass_commandpost|".." - |03")
		Mission.CP6 = FindEntity("CP06M")
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |04")
		...
		Mission.CB6 = FindEntity("CB6")	-- TODO: Itt atirtam hogy ne a CB3at talalja meg hanem a 6ost gondolom bug volt
		Mission.CB6.CaptureWeight = 2
		Mission.CB6.StrategicGain = 4		
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 6 Params")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 8 Params")
		...
		Mission.CB9.CaptureWeight = 2
		Mission.CB9.StrategicGain = 7		
		SetGuiName(Mission.CB9, "globals.unitclass_headquarter|".." - |08")
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP6 = FindEntity("CP06S")
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |01")
...
function luaShowMissionHint()
	ShowHint("ID_Hint_IslandCapture06")
