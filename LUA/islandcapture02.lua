...
function luaStageInit()
	CreateScript("luaInitIslandCapture02")
end

function luaInitIslandCapture02(this)
	Mission = this
	Mission.Name = "IslandCapture02"
-- logolasok
--	DamageLog = true
--	Mission.HelperLog = true
	Mission.CustomLog = true
	SETLOG(this, true)
-- RELEASE_LOGOFF  	Log("Initiating IslandCapture02")
	-- Loc-Kit dolgok
...
-- RELEASE_LOGOFF  		luaLog("Initiating Island Capture Mode 4v4")
		...
		table.insert(Mission.Shipyards, FindEntity("Shipyard Entity CB8"))
		table.insert(Mission.Shipyards, FindEntity("Shipyard Entity CB10"))
		table.insert(Mission.Shipyards, FindEntity("Shipyard Entity CB11"))
		table.insert(Mission.Shipyards, FindEntity("Shipyard Entity CB13"))
...
-- RELEASE_LOGOFF  --		luaLog("")
		...
		Mission.CP1 = FindEntity("CP01 H")
		SetGuiName(Mission.CP1, "globals.unitclass_commandpost|".." - |01")
		Mission.CP2 = FindEntity("CP02 H")
		SetGuiName(Mission.CP2, "globals.unitclass_commandpost|".." - |06")
		Mission.CP3 = FindEntity("CP03 H")
		SetGuiName(Mission.CP3, "globals.unitclass_commandpost|".." - |07")
		Mission.CP4 = FindEntity("CP04 H")
		SetGuiName(Mission.CP4, "globals.unitclass_commandpost|".." - |09")
		Mission.CP5 = FindEntity("CP05 H")
		SetGuiName(Mission.CP5, "globals.unitclass_commandpost|".." - |11")
		Mission.CP6 = FindEntity("CP06 H")
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |12")
		Mission.CP7 = FindEntity("CP07 H")
		SetGuiName(Mission.CP7, "globals.unitclass_commandpost|".." - |14")
		Mission.CP8 = FindEntity("CP08 H")
		SetGuiName(Mission.CP8, "globals.unitclass_commandpost|".." - |15")
		Mission.CP9 = FindEntity("CP09 H")
		SetGuiName(Mission.CP9, "globals.unitclass_commandpost|".." - |17")
		Mission.CP10 = FindEntity("CP10 H")
		SetGuiName(Mission.CP10, "globals.unitclass_commandpost|".." - |19")
		Mission.CP11 = FindEntity("CP11 H")
		SetGuiName(Mission.CP11, "globals.unitclass_commandpost|".." - |20")
		Mission.CP12 = FindEntity("CP12 H")
		SetGuiName(Mission.CP12, "globals.unitclass_commandpost|".." - |24")
		...
		SetGuiName(Mission.CB1, "globals.unitclass_headquarter|".." - |02")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 3 Params")
		...
		SetCommandBuildingOwnerPlayer(Mission.CB4, PLAYER_6)
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 7 Params")
		...
		SetGuiName(Mission.CB8, "globals.unitclass_headquarter|".." - |16")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 8 Params")
		...
		SetGuiName(Mission.CB9, "globals.unitclass_headquarter|".." - |18")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 9 Params")
		Mission.CB10 = FindEntity("CB10")
		Mission.CB10.CaptureWeight = 3
		Mission.CB10.StrategicGain = 5
		--SetCommandBuildingOwnerPlayer(Mission.CB10, PLAYER_1)
		--SetParty(Mission.CB10, PARTY_JAPANESE)
		--SetRoleAvailable(Mission.CB10,EROLF_ALL,PLAYER_6)
		SetGuiName(Mission.CB10, "globals.unitclass_headquarter|".." - |21")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 10 Params")
		Mission.CB11 = FindEntity("CB11")
		Mission.CB11.CaptureWeight = 3
		Mission.CB11.StrategicGain = 5
		--SetParty(Mission.CB11, PARTY_ALLIED)
		--SetRoleAvailable(Mission.CB11,EROLF_ALL,PLAYER_2)
		SetGuiName(Mission.CB11, "globals.unitclass_headquarter|".." - |22")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 11 Params")
		Mission.CB12 = FindEntity("CB12")
		Mission.CB12.CaptureWeight = 2
		Mission.CB12.StrategicGain = 4
		SetCommandBuildingOwnerPlayer(Mission.CB12, PLAYER_1)
		SetGuiName(Mission.CB12, "globals.unitclass_headquarter|".." - |23")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 12 Params")
		Mission.CB13 = FindEntity("CB13")
		Mission.CB13.CaptureWeight = 2
		Mission.CB13.StrategicGain = 4
		SetCommandBuildingOwnerPlayer(Mission.CB13, PLAYER_2)
		SetGuiName(Mission.CB13, "globals.unitclass_headquarter|".." - |25")
...
--		table.insert(Mission.CommandBuildings, FindEntity("CB10"))
		...
		Mission.CP2 = FindEntity("CP02 L")
		SetGuiName(Mission.CP2, "globals.unitclass_commandpost|".." - |03")
		Mission.CP4 = FindEntity("CP04 L")
		SetGuiName(Mission.CP4, "globals.unitclass_commandpost|".." - |05")
		Mission.CP5 = FindEntity("CP05 H")
		SetGuiName(Mission.CP5, "globals.unitclass_commandpost|".." - |07")
		Mission.CP6 = FindEntity("CP06 L")
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |08")
		Mission.CP7 = FindEntity("CP07 L")
		SetGuiName(Mission.CP7, "globals.unitclass_commandpost|".." - |10")
		Mission.CP8 = FindEntity("CP08 H")
		SetGuiName(Mission.CP8, "globals.unitclass_commandpost|".." - |11")
		Mission.CP9 = FindEntity("CP09 L")
		SetGuiName(Mission.CP9, "globals.unitclass_commandpost|".." - |13")
		Mission.CP11 = FindEntity("CP11 L")
		SetGuiName(Mission.CP11, "globals.unitclass_commandpost|".." - |15")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 7 Params")
		...
		SetGuiName(Mission.CB8, "globals.unitclass_headquarter|".." - |12")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 8 Params")
		Mission.CB9 = FindEntity("CB9")
		Mission.CB9.CaptureWeight = 2
		Mission.CB9.StrategicGain = 7
		SetCommandBuildingOwnerPlayer(Mission.CB9, PLAYER_5)
		SetGuiName(Mission.CB9, "globals.unitclass_headquarter|".." - |14")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 9 Params")
--		Mission.CB10 = FindEntity("CB10")
--		Mission.CB10.CaptureWeight = 3
--		Mission.CB10.StrategicGain = 5
--		SetCommandBuildingOwnerPlayer(Mission.CB10, PLAYER_5)
		--SetParty(Mission.CB10, PARTY_JAPANESE)
		--SetRoleAvailable(Mission.CB10,EROLF_ALL,PLAYER_6)
--		SetGuiName(Mission.CB10, "globals.unitclass_headquarter|".." - |16")
-- RELEASE_LOGOFF  --		luaLog("Setting Command Building 10 Params")
		Mission.CB11 = FindEntity("CB11")
		Mission.CB11.CaptureWeight = 3
		Mission.CB11.StrategicGain = 5
		SetCommandBuildingOwnerPlayer(Mission.CB11, PLAYER_5)
		--SetParty(Mission.CB11, PARTY_ALLIED)
		--SetRoleAvailable(Mission.CB11,EROLF_ALL,PLAYER_2)
		SetGuiName(Mission.CB11, "globals.unitclass_headquarter|".." - |17")
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 11 Params")
		--Mission.CB12 = FindEntity("CB12")
		--Mission.CB12.CaptureWeight = 3
		--Mission.CB12.StrategicGain = 5
		--SetCommandBuildingOwnerPlayer(Mission.CB12, PLAYER_6)
		--SetGuiName(Mission.CB12, "globals.unitclass_headquarter|".." - |23")
		--Mission.CB13 = FindEntity("CB13")
		--Mission.CB13.CaptureWeight = 3
		--Mission.CB13.StrategicGain = 5
		--SetGuiName(Mission.CB13, "globals.unitclass_headquarter|".." - |25")
		-- CommandBuildings TODO: SetGuiName (multiban atmegy? (grave))
...
--			table.insert(Mission.JPCB, Mission.CB10)
			table.insert(Mission.JPCB, Mission.CB11)
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP4 = FindEntity("CP04 M")
		SetGuiName(Mission.CP4, "globals.unitclass_commandpost|".." - |02")
		Mission.CP5 = FindEntity("CP05 H")
		SetGuiName(Mission.CP5, "globals.unitclass_commandpost|".." - |04")
		Mission.CP6 = FindEntity("CP06 M")
		SetGuiName(Mission.CP6, "globals.unitclass_commandpost|".." - |05")
		Mission.CP7 = FindEntity("CP07 M")
		SetGuiName(Mission.CP7, "globals.unitclass_commandpost|".." - |07")
		Mission.CP8 = FindEntity("CP08 H")
		SetGuiName(Mission.CP8, "globals.unitclass_commandpost|".." - |08")
		Mission.CP9 = FindEntity("CP09 M")
		SetGuiName(Mission.CP9, "globals.unitclass_commandpost|".." - |10")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 8 Params")
		SetGuiName(Mission.CB8, "globals.unitclass_headquarter|".." - |09")
		Mission.CB9 = FindEntity("CB9")
		Mission.CB9.CaptureWeight = 2
		Mission.CB9.StrategicGain = 7
		SetCommandBuildingOwnerPlayer(Mission.CB9, PLAYER_5)
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 9 Params")
		SetGuiName(Mission.CB9, "globals.unitclass_headquarter|".." - |11")
		--Mission.CB10 = FindEntity("CB10")
		--SetGuiName(Mission.CB10, "globals.unitclass_headquarter|".." - |21")
		--Mission.CB11 = FindEntity("CB11")
		--SetGuiName(Mission.CB11, "globals.unitclass_headquarter|".." - |22")
		--Mission.CB12 = FindEntity("CB12")
		--SetGuiName(Mission.CB12, "globals.unitclass_headquarter|".." - | 10")
		--Mission.CB13 = FindEntity("CB13")
		--SetGuiName(Mission.CB13, "globals.unitclass_headquarter|".." - |25")
		-- CommandBuildings TODO: SetGuiName (multiban atmegy? (grave))
		-- todo modelltol fuggo a nev
...
-- RELEASE_LOGOFF  		luaLog("")
		...
		Mission.CP5 = FindEntity("CP05 H")
		SetGuiName(Mission.CP5, "globals.unitclass_commandpost|".." - |02")
		Mission.CP8 = FindEntity("CP08 H")
		SetGuiName(Mission.CP8, "globals.unitclass_commandpost|".." - |04")
...
-- RELEASE_LOGOFF  		luaLog("Setting Command Building 6 Params")
		...
		Mission.CB7.CaptureWeight = 4
		Mission.CB7.StrategicGain = 7
		SetGuiName(Mission.CB7, "globals.unitclass_headquarter|".." - |03")
-- RELEASE_LOGOFF  		luaLog("")
		Mission.CB8 = FindEntity("CB8")
		Mission.CB8.CaptureWeight = 2
		Mission.CB8.StrategicGain = 4
...
-- korulmenyek beallitasa
    ...
    SetThink(this, "luaIslandCapture02_think")
...
-------------------------				THINK				---------------------------------------------
-----------------------------------------------------------------------------------------
function luaIslandCapture02_think(this, msg)
...
function luaShowMissionHint()
	ShowHint("ID_Hint_IslandCapture02")
