...
-- RELEASE_LOGOFF  		luaLog("  Japanese side wins")
		...
		if LobbySettings.UnitType == "globals.unitcat_battleship" and Mission.JapaneseRoundWon >= 3 and Mission.AlliedRoundWon == 0 then
			for i = 4, 7 do
-- RELEASE_LOGOFF  				luaLog("  player "..i.." MA_DLC03TD")
				SetAchievements(i, "MA_DLC03TD")
			end
		end
