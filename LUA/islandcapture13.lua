...
-- RELEASE_LOGOFF  		luaLog("Initiating Island Capture Mode 3v3")
		...
		Mission.Shipyards = {}
		table.insert(Mission.Shipyards, FindEntity("SY_L01_3v3"))
		table.insert(Mission.Shipyards, FindEntity("SY_L02_3v3"))			
		table.insert(Mission.Shipyards, FindEntity("SY_L03_3v3"))
		table.insert(Mission.Shipyards, FindEntity("SY_L04_3v3"))
		table.insert(Mission.Shipyards, FindEntity("SY_M01_3v3"))
		table.insert(Mission.Shipyards, FindEntity("SY_M02_3v3"))
		
		Mission.CommandBuildings = {}
-- RELEASE_LOGOFF  		luaLog("")
		table.insert(Mission.CommandBuildings, FindEntity("HQ M01 3v3"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ M02 3v3"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ L01 01 3v3"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ L01 02 3v3"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ L01 03 3v3"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ L01 04 3v3"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ S01 3v3"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ S02 3v3"))		

		
		--Mission.CB1 = FindEntity("HQ S01 3v3")
		--SetGuiName(Mission.CB1, "globals.unitclass_headquarter|".." - |01")
		
		Mission.CB2 = FindEntity("HQ M01 3v3")
		--SetGuiName(Mission.CB2, "globals.unitclass_headquarter|".." - |01")	
		SetGuiName(Mission.CB2, "globals.unitclass_headquarter|".." - |04")
		
		Mission.CB3 = FindEntity("HQ L01 01 3v3")
		--SetGuiName(Mission.CB3, "globals.unitclass_headquarter|".." - |02")
		SetGuiName(Mission.CB3, "globals.unitclass_headquarter|".." - |03")
		
		Mission.CB4 = FindEntity("HQ L01 02 3v3") 
		--SetGuiName(Mission.CB4, "globals.unitclass_headquarter|".." - |03")
		SetGuiName(Mission.CB4, "globals.unitclass_headquarter|".." - |02")
				
		Mission.CB5 = FindEntity("HQ M02 3v3")
		--SetGuiName(Mission.CB5, "globals.unitclass_headquarter|".." - |04")
		SetGuiName(Mission.CB5, "globals.unitclass_headquarter|".." - |05")
						
		Mission.CB6 = FindEntity("HQ L01 03 3v3")
		--SetGuiName(Mission.CB6, "globals.unitclass_headquarter|".." - |05")
		SetGuiName(Mission.CB6, "globals.unitclass_headquarter|".." - |07")
						
		Mission.CB7 = FindEntity("HQ L01 04 3v3")
		SetGuiName(Mission.CB7, "globals.unitclass_headquarter|".." - |06")
		
		--Mission.CB8 = FindEntity("HQ S02 3v3")
		...
		Mission.CB7.StrategicGain = 3

		Mission.CommandPosts = {}
		
		Mission.CP1 = FindEntity("HQ S01 3v3")
		SetGuiName(Mission.CP1, "globals.unitclass_commandpost|".." - |01")
		
		Mission.CP2 = FindEntity("HQ S02 3v3")
		--SetGuiName(Mission.CP2, "globals.unitclass_commandpost|".." - |02")
		SetGuiName(Mission.CP2, "globals.unitclass_commandpost|".." - |08")
		
		--table.insert(Mission.CommandPosts, FindEntity("Powerup 01"))
		
		SetCommandBuildingOwnerPlayer(Mission.CB5, PLAYER_5)
		SetParty(Mission.CB5, PARTY_JAPANESE)
		SetRoleAvailable(Mission.CB5,EROLF_ALL,PLAYER_5)

		SetCommandBuildingOwnerPlayer(Mission.CB2, PLAYER_1)
		SetParty(Mission.CB2, PARTY_ALLIED)
		SetRoleAvailable(Mission.CB2,EROLF_ALL,PLAYER_1)
		
		Mission.USNCV1 = FindEntity("Lexington-class 3v3")
		SetParty(Mission.USNCV1, PARTY_ALLIED)
		SetRoleAvailable(Mission.USNCV1, EROLF_ALL,PLAYER_1)
		
		
		Mission.USNCV2 = FindEntity("Yorktown-class 3v3")
		SetParty(Mission.USNCV2, PARTY_ALLIED)
		SetRoleAvailable(Mission.USNCV2, EROLF_ALL,PLAYER_1)
		

		Mission.IJNCV1 = FindEntity("Soryu-class 3v3")
		SetParty(Mission.IJNCV1, PARTY_JAPANESE)
		SetRoleAvailable(Mission.IJNCV1, EROLF_ALL,PLAYER_5)

		Mission.IJNCV2 = FindEntity("Akagi-class 3v3")
		...
		Mission.JPCB = {Mission.IJNCV1, Mission.IJNCV2}
			table.insert(Mission.JPCB, Mission.CB5)
		Mission.USCVs = {}
...
-- RELEASE_LOGOFF  		luaLog("Initiating Island Capture Mode 2v2")
		...
		Mission.Shipyards = {}
		table.insert(Mission.Shipyards, FindEntity("SY_HQ01_2v2"))
		table.insert(Mission.Shipyards, FindEntity("SY_HQ02_2v2"))			
		table.insert(Mission.Shipyards, FindEntity("SY_HQ03_2v2"))
		table.insert(Mission.Shipyards, FindEntity("SY_HQ04_2v2"))
		
		Mission.CommandBuildings = {}
-- RELEASE_LOGOFF  		luaLog("")
		table.insert(Mission.CommandBuildings, FindEntity("HQ S01 2v2"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ S02 2v2"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ 02 2v2"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ 03 2v2"))
		

		
		Mission.CB1 = FindEntity("HQ S01 2v2")
		SetGuiName(Mission.CB1, "globals.unitclass_headquarter|".." - |01")
		
		Mission.CB2 = FindEntity("HQ 02 2v2")
		--SetGuiName(Mission.CB2, "globals.unitclass_headquarter|".." - |02")
		SetGuiName(Mission.CB2, "globals.unitclass_headquarter|".." - |03")
		
		Mission.CB3 = FindEntity("HQ 03 2v2")
		--SetGuiName(Mission.CB3, "globals.unitclass_headquarter|".." - |03")
		SetGuiName(Mission.CB3, "globals.unitclass_headquarter|".." - |04")
		
		Mission.CB4 = FindEntity("HQ S02 2v2")
		--SetGuiName(Mission.CB4, "globals.unitclass_headquarter|".." - |04")
		SetGuiName(Mission.CB4, "globals.unitclass_headquarter|".." - |06")
				
		
		
		Mission.CP01 = FindEntity("HQ PU 01 2v2")
		--SetGuiName(Mission.CP01, "globals.unitclass_commandpost|".." - |01")
		SetGuiName(Mission.CP01, "globals.unitclass_commandpost|".." - |02")
		
		Mission.CP02 = FindEntity("HQ PU 02 2v2")
		--SetGuiName(Mission.CP02, "globals.unitclass_commandpost|".." - |02")
		SetGuiName(Mission.CP02, "globals.unitclass_commandpost|".." - |05")
	
		
		
		Mission.CB1.CaptureWeight = 1
		Mission.CB1.StrategicGain = 3
		Mission.CB2.CaptureWeight = 1
		Mission.CB2.StrategicGain = 6
		Mission.CB3.CaptureWeight = 1
		Mission.CB3.StrategicGain = 6
		Mission.CB4.CaptureWeight = 1
		Mission.CB4.StrategicGain = 3
		
		Mission.CP01.CaptureWeight = 1
		Mission.CP01.StrategicGain = 4
		Mission.CP02.CaptureWeight = 1
		Mission.CP02.StrategicGain = 4
		

		Mission.CommandPosts = {}

		table.insert(Mission.CommandPosts, FindEntity("HQ PU 01 2v2"))
		table.insert(Mission.CommandPosts, FindEntity("HQ PU 02 2v2"))		
		...
		Mission.USNCV1 = FindEntity("Lexington-class 2v2")
		SetParty(Mission.USNCV1, PARTY_ALLIED)
		SetRoleAvailable(Mission.USNCV1, EROLF_ALL,PLAYER_1)
		
		
		Mission.USNCV2 = FindEntity("Yorktown-class 2v2")
		SetParty(Mission.USNCV2, PARTY_ALLIED)
		SetRoleAvailable(Mission.USNCV2, EROLF_ALL,PLAYER_1)
		

		Mission.IJNCV1 = FindEntity("Akagi-class 2v2")
		SetParty(Mission.IJNCV1, PARTY_JAPANESE)
		SetRoleAvailable(Mission.IJNCV1, EROLF_ALL,PLAYER_5)

		Mission.IJNCV2 = FindEntity("Kaga-class 2v2")
		SetParty(Mission.IJNCV2, PARTY_JAPANESE)
		SetRoleAvailable(Mission.IJNCV2, EROLF_ALL,PLAYER_5)
...
-- RELEASE_LOGOFF  		luaLog("Initiating Island Capture Mode 1v1")
		...
		table.insert(Mission.Shipyards, FindEntity("SY_HQ01_1v1"))			
		table.insert(Mission.Shipyards, FindEntity("SY_HQ03_1v1"))
		table.insert(Mission.Shipyards, FindEntity("SY_HQ05_1v1"))
		table.insert(Mission.Shipyards, FindEntity("SY_HQ06_1v1"))
		table.insert(Mission.Shipyards, FindEntity("SY_S03_1v1"))
		table.insert(Mission.Shipyards, FindEntity("SY_S04_1v1"))
		
		Mission.CommandBuildings = {}

		table.insert(Mission.CommandBuildings, FindEntity("HQ_S03_1v1"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ_S04_1v1"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ 01 1v1"))		
		table.insert(Mission.CommandBuildings, FindEntity("HQ 03 1v1"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ 05 1v1"))
		table.insert(Mission.CommandBuildings, FindEntity("HQ 06 1v1"))
		

		Mission.CB1 = FindEntity("HQ_S03_1v1")
		SetGuiName(Mission.CB1, "globals.unitclass_headquarter|".." - |01")

		Mission.CB2 = FindEntity("HQ_S04_1v1")
		--SetGuiName(Mission.CB2, "globals.unitclass_headquarter|".." - |02")
		SetGuiName(Mission.CB2, "globals.unitclass_headquarter|".." - |06")
				
		Mission.CB3 = FindEntity("HQ 01 1v1")
		--SetGuiName(Mission.CB3, "globals.unitclass_headquarter|".." - |03")
		SetGuiName(Mission.CB3, "globals.unitclass_headquarter|".." - |05")
		
		Mission.CB4 = FindEntity("HQ 03 1v1")
		--SetGuiName(Mission.CB4, "globals.unitclass_headquarter|".." - |04")
		SetGuiName(Mission.CB4, "globals.unitclass_headquarter|".." - |03")
		
		Mission.CB5 = FindEntity("HQ 05 1v1")
		--SetGuiName(Mission.CB5, "globals.unitclass_headquarter|".." - |05")
		SetGuiName(Mission.CB5, "globals.unitclass_headquarter|".." - |02")
		
		Mission.CB6 = FindEntity("HQ 06 1v1")
...
--  SetGuiName(Mission.CP04, "globals.unitclass_commandpost|".." - |04")
		...
		Mission.CB1.CaptureWeight = 1
		Mission.CB1.StrategicGain = 12		
		Mission.CB2.CaptureWeight = 1
		Mission.CB2.StrategicGain = 12
		Mission.CB3.CaptureWeight = 1
		Mission.CB3.StrategicGain = 6
		Mission.CB4.CaptureWeight = 1
		Mission.CB4.StrategicGain = 6
		Mission.CB5.CaptureWeight = 1
		Mission.CB5.StrategicGain = 6		
		Mission.CB6.CaptureWeight = 1
		Mission.CB6.StrategicGain = 6		
		...
		Mission.USNCV1 = FindEntity("US_CV_1v1")
		SetParty(Mission.USNCV1, PARTY_ALLIED)
		SetRoleAvailable(Mission.USNCV1, EROLF_ALL,PLAYER_1)

		Mission.IJNCV1 = FindEntity("JAP_CV_1v1")
		SetParty(Mission.IJNCV1, PARTY_JAPANESE)
		SetRoleAvailable(Mission.IJNCV1, EROLF_ALL,PLAYER_5)

		Mission.USCB = {Mission.USNCV1}
			table.insert(Mission.USCB, Mission.CB4)
		Mission.JPCB = {Mission.IJNCV1}
...
function luaSetObjectives()	
	...
	if Mission.IC3v3 == true then
		...
		--luaShowMissionHint()
		-- allied objs
		luaObj_Add("primary", 1, { Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB6, Mission.CB7,  Mission.USNCV1, Mission.IJNCV1, Mission.USNCV2, Mission.IJNCV2, })
		-- japanese objs
		luaObj_Add("primary", 2, { Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB6, Mission.CB7,  Mission.USNCV1, Mission.IJNCV1, Mission.USNCV2, Mission.IJNCV2, })
		Mission.MissionInit = false
		end	
	end
	...
	if Mission.IC2v2 == true then
		...
		--luaShowMissionHint()
		-- allied objs
		luaObj_Add("primary", 1, {Mission.CB1, Mission.CB2, Mission. CB3, Mission.CB4, Mission.USNCV1, Mission.IJNCV1, Mission.USNCV2, Mission.IJNCV2,})
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.CB1, Mission.CB2, Mission. CB3, Mission.CB4, Mission.USNCV1, Mission.IJNCV1, Mission.USNCV2, Mission.IJNCV2,})
		Mission.MissionInit = false
		end	
	end
...
-- RELEASE_LOGOFF  		luaLog("Hint mejelenites")
		--luaShowMissionHint()
		-- allied objs
		luaObj_Add("primary", 1, {Mission.CB1, Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB6, Mission.USNCV1, Mission.IJNCV1, })
		-- japanese objs
		luaObj_Add("primary", 2, {Mission.CB1, Mission.CB2, Mission.CB3, Mission.CB4, Mission.CB5, Mission.CB6, Mission.USNCV1, Mission.IJNCV1, })
		Mission.MissionInit = false
		end	
	end
end
...
-- RELEASE_LOGOFF  				luaLog(" Checking carriers for US AI in 1v1")
				if not Mission.USAIInitDone then
					Mission.USAI = {}
					Mission.USAI.Lexington = FindEntity("US_CV_1v1") -- Hermes
...
-- RELEASE_LOGOFF  							luaLog("  Mission.USAI.Lexington.ToDepo -- Hermes")
							NavigatorMoveToPos(Mission.USAI.Lexington, {["x"] = -3137.6, ["y"] = 0, ["z"] = 5293.7})
							Mission.USAI.Lexington.ToDepo = true
						elseif not Mission.USAI.Lexington.Retreating then
							local hostileShips = luaGetShipsAroundCoordinate(GetPosition(Mission.USAI.Lexington), 8000, PARTY_ALLIED, "enemy")
							local hostilePlanes = luaGetPlanesAroundCoordinate(GetPosition(Mission.USAI.Lexington), 8000, PARTY_ALLIED, "enemy")
							local hostiles = luaGetHostiles(hostileShips, hostilePlanes)
							if hostiles > 2 then
-- RELEASE_LOGOFF  								luaLog("  Mission.USAI.Lexington.Retreating -- Hermes")
								if FindEntity("HQ_S03_1v1").Party ~= PARTY_ALLIED then
									NavigatorMoveToPos(Mission.USAI.Lexington, {["x"] = -3741.6, ["y"] = 0, ["z"] = -1026.2})
								end
...
-- RELEASE_LOGOFF  				luaLog(" Checking carriers for US AI in 2v2")
				if not Mission.USAIInitDone then
					Mission.USAI = {}
					Mission.USAI.Lexington = FindEntity("Lexington-class 2v2")
					Mission.USAI.Yorktown = FindEntity("Yorktown-class 2v2")
					Mission.USAI.IgnoreLexington = false
					Mission.USAI.IgnoreYorktown = false
					Mission.USAI.Lexington.Retreating = false
					Mission.USAI.Yorktown.Retreating = false
					Mission.USAIInitDone = true
				end
...
-- RELEASE_LOGOFF  							luaLog("  Mission.USAI.Lexington.ToDepo")
							NavigatorMoveToPos(Mission.USAI.Lexington, {["x"] = 3050.0, ["y"] = 0, ["z"] = -1767.1})
							Mission.USAI.Lexington.ToDepo = true
						elseif not Mission.USAI.Lexington.Retreating then
							local hostileShips = luaGetShipsAroundCoordinate(GetPosition(Mission.USAI.Lexington), 10000, PARTY_ALLIED, "enemy")
							local hostilePlanes = luaGetPlanesAroundCoordinate(GetPosition(Mission.USAI.Lexington), 10000, PARTY_ALLIED, "enemy")
							local hostiles = luaGetHostiles(hostileShips, hostilePlanes)
							if hostiles > 2 then
-- RELEASE_LOGOFF  								luaLog("  Mission.USAI.Lexington.Retreating")
								NavigatorMoveToPos(Mission.USAI.Lexington, {["x"] = 200.2, ["y"] = 0, ["z"] = -9916.2})
								Mission.USAI.Lexington.Retreating = true
							end
						end
					else
				...
				if not Mission.USAI.IgnoreYorktown then
					if not Mission.USAI.Yorktown.Dead then
						if not Mission.USAI.Yorktown.ToDepo then
-- RELEASE_LOGOFF  							luaLog("  Mission.USAI.Yorktown.ToDepo")
							NavigatorMoveToPos(Mission.USAI.Yorktown, {["x"] = 198.9, ["y"] = 0, ["z"] = -2872.5})
							Mission.USAI.Yorktown.ToDepo = true
						elseif not Mission.USAI.Yorktown.Retreating then
							local hostileShips = luaGetShipsAroundCoordinate(GetPosition(Mission.USAI.Yorktown), 10000, PARTY_ALLIED, "enemy")
							local hostilePlanes = luaGetPlanesAroundCoordinate(GetPosition(Mission.USAI.Yorktown), 10000, PARTY_ALLIED, "enemy")
							local hostiles = luaGetHostiles(hostileShips, hostilePlanes)
							if hostiles > 2 then
-- RELEASE_LOGOFF  								luaLog("  Mission.USAI.Yorktown.Retreating")
								NavigatorMoveToPos(Mission.USAI.Yorktown, {["x"] = -1066.6, ["y"] = 0, ["z"] = -10435.1})
								Mission.USAI.Yorktown.Retreating = true
							end
						end
					else
...
-- RELEASE_LOGOFF  				luaLog(" Checking carriers for US AI in 3v3")
				if not Mission.USAIInitDone then
					Mission.USAI = {}
					Mission.USAI.Lexington = FindEntity("Lexington-class 3v3")
					Mission.USAI.Yorktown = FindEntity("Yorktown-class 3v3")
					Mission.USAI.IgnoreLexington = false
					Mission.USAI.IgnoreYorktown = false
					Mission.USAI.Lexington.Retreating = false
					Mission.USAI.Yorktown.Retreating = false
				...
				if not Mission.USAI.IgnoreLexington then
					if not Mission.USAI.Lexington.Dead then
						if not Mission.USAI.Lexington.ToDepo then
-- RELEASE_LOGOFF  							luaLog("  Mission.USAI.Lexington.ToDepo")
							NavigatorMoveToPos(Mission.USAI.Lexington, {["x"] = -3885.9, ["y"] = 0, ["z"] = 890.1})
							Mission.USAI.Lexington.ToDepo = true
						elseif not Mission.USAI.Lexington.Retreating then
							...
							if hostiles > 2 then
-- RELEASE_LOGOFF  								luaLog("  Mission.USAI.Lexington.Retreating")
								NavigatorMoveToPos(Mission.USAI.Lexington, {["x"] = -10995.7, ["y"] = 0, ["z"] = -918.7})
								Mission.USAI.Lexington.Retreating = true
							end
						end
					else
				...
				if not Mission.USAI.IgnoreYorktown then
					if not Mission.USAI.Yorktown.Dead then
						if not Mission.USAI.Yorktown.ToDepo then
-- RELEASE_LOGOFF  							luaLog("  Mission.USAI.Yorktown.ToDepo")
							NavigatorMoveToPos(Mission.USAI.Yorktown, {["x"] = -2574.8, ["y"] = 0, ["z"] = -2018.7})
							Mission.USAI.Yorktown.ToDepo = true
						elseif not Mission.USAI.Yorktown.Retreating then
							local hostileShips = luaGetShipsAroundCoordinate(GetPosition(Mission.USAI.Yorktown), 10000, PARTY_ALLIED, "enemy")
							local hostilePlanes = luaGetPlanesAroundCoordinate(GetPosition(Mission.USAI.Yorktown), 10000, PARTY_ALLIED, "enemy")
							...
							if hostiles > 2 then
-- RELEASE_LOGOFF  								luaLog("  Mission.USAI.Yorktown.Retreating")
								NavigatorMoveToPos(Mission.USAI.Yorktown, {["x"] = -9143, ["y"] = 0, ["z"] = 227.9})
								Mission.USAI.Yorktown.Retreating = true
							end
						end
					else
...
-- RELEASE_LOGOFF  				luaLog(" Checking carriers for Japanese AI in 1v1")
				if not Mission.JapAIInitDone then
					Mission.JapAI = {}
					Mission.JapAI.Soryu = FindEntity("JAP_CV_1v1") -- Shoho
...
-- RELEASE_LOGOFF  							luaLog("  Mission.JapAI.Soryu.ToDepo -- Shoho")
							NavigatorMoveToPos(Mission.JapAI.Soryu, {["x"] = 2864.0, ["y"] = 0, ["z"] = -6020.0})
							Mission.JapAI.Soryu.ToDepo = true
						elseif not Mission.JapAI.Soryu.Retreating then
							local hostileShips = luaGetShipsAroundCoordinate(GetPosition(Mission.JapAI.Soryu), 8000, PARTY_JAPANESE, "enemy")
							local hostilePlanes = luaGetPlanesAroundCoordinate(GetPosition(Mission.JapAI.Soryu), 8000, PARTY_JAPANESE, "enemy")
							local hostiles = luaGetHostiles(hostileShips, hostilePlanes)
							if hostiles > 2 then
-- RELEASE_LOGOFF  								luaLog("  Mission.JapAI.Soryu.Retreating -- Shoho")
								if FindEntity("HQ_S04_1v1").Party ~= PARTY_JAPANESE then
									NavigatorMoveToPos(Mission.JapAI.Soryu, {["x"] = 3002.0, ["y"] = 0, ["z"] = -1557.1})
								end
...
-- RELEASE_LOGOFF  				luaLog(" Checking carriers for Japanese AI in 2v2")
				if not Mission.JapAIInitDone then
					Mission.JapAI = {}
					Mission.JapAI.Soryu = FindEntity("Akagi-class 2v2")
					Mission.JapAI.Hiryu = FindEntity("Kaga-class 2v2")
					Mission.JapAI.IgnoreSoryu = false
					Mission.JapAI.IgnoreHiryu = false
					Mission.JapAI.Soryu.Retreating = false
					Mission.JapAI.Hiryu.Retreating = false
					Mission.JapAIInitDone = true
				end
				...
				if not Mission.JapAI.IgnoreSoryu then
					if not Mission.JapAI.Soryu.Dead then
						if not Mission.JapAI.Soryu.ToDepo then
-- RELEASE_LOGOFF  							luaLog("  Mission.JapAI.Soryu.ToDepo -- Akagi")
							NavigatorMoveToPos(Mission.JapAI.Soryu, {["x"] = -3403.6, ["y"] = 0, ["z"] = 1243.7})
							Mission.JapAI.Soryu.ToDepo = true
						elseif not Mission.JapAI.Soryu.Retreating then
							...
							local hostiles = luaGetHostiles(hostileShips, hostilePlanes)
							if hostiles > 2 then
-- RELEASE_LOGOFF  								luaLog("  Mission.JapAI.Soryu.Retreating -- Akagi")
								NavigatorMoveToPos(Mission.JapAI.Soryu, {["x"] = -489.3, ["y"] = 0, ["z"] = 9654.1})
								Mission.JapAI.Soryu.Retreating = true
							end
						end
					else
				...
				if not Mission.JapAI.IgnoreHiryu then
					if not Mission.JapAI.Hiryu.Dead then
						if not Mission.JapAI.Hiryu.ToDepo then
-- RELEASE_LOGOFF  							luaLog("  Mission.JapAI.Hiryu.ToDepo -- Kaga")
							NavigatorMoveToPos(Mission.JapAI.Hiryu, {["x"] = -525.9, ["y"] = 0, ["z"] = 1718.2})
							Mission.JapAI.Hiryu.ToDepo = true
						elseif not Mission.JapAI.Hiryu.Retreating then
							local hostileShips = luaGetShipsAroundCoordinate(GetPosition(Mission.JapAI.Hiryu), 15000, PARTY_JAPANESE, "enemy")
							local hostilePlanes = luaGetPlanesAroundCoordinate(GetPosition(Mission.JapAI.Hiryu), 15000, PARTY_JAPANESE, "enemy")
							local hostiles = luaGetHostiles(hostileShips, hostilePlanes)
							if hostiles > 2 then
-- RELEASE_LOGOFF  								luaLog("  Mission.JapAI.Hiryu.Retreating -- Kaga")
								NavigatorMoveToPos(Mission.JapAI.Hiryu, {["x"] = 695.8, ["y"] = 0, ["z"] = 8906.2})
								Mission.JapAI.Hiryu.Retreating = true
							end
						end
					else
...
-- RELEASE_LOGOFF  				luaLog(" Checking carriers for Japanese AI in 3v3")
				if not Mission.JapAIInitDone then
					Mission.JapAI = {}
					Mission.JapAI.Soryu = FindEntity("Akagi-class 3v3")
					Mission.JapAI.Hiryu = FindEntity("Soryu-class 3v3")
					Mission.JapAI.IgnoreSoryu = false
					Mission.JapAI.IgnoreHiryu = false
					Mission.JapAI.Soryu.Retreating = false
					Mission.JapAI.Hiryu.Retreating = false
				...
				if not Mission.JapAI.IgnoreSoryu then
					if not Mission.JapAI.Soryu.Dead then
						if not Mission.JapAI.Soryu.ToDepo then
-- RELEASE_LOGOFF  							luaLog("  Mission.JapAI.Soryu.ToDepo -- Akagi")
							NavigatorMoveToPos(Mission.JapAI.Soryu, {["x"] = 1707.7, ["y"] = 0, ["z"] = 1883.6})
							Mission.JapAI.Soryu.ToDepo = true
						elseif not Mission.JapAI.Soryu.Retreating then
							local hostileShips = luaGetShipsAroundCoordinate(GetPosition(Mission.JapAI.Soryu), 15000, PARTY_JAPANESE, "enemy")
							local hostilePlanes = luaGetPlanesAroundCoordinate(GetPosition(Mission.JapAI.Soryu), 15000, PARTY_JAPANESE, "enemy")
							...
							if hostiles > 2 then
-- RELEASE_LOGOFF  								luaLog("  Mission.JapAI.Soryu.Retreating -- Akagi")
								NavigatorMoveToPos(Mission.JapAI.Soryu, {["x"] = 9306.2, ["y"] = 0, ["z"] = 700.7})
								Mission.JapAI.Soryu.Retreating = true
							end
						end
					else
				...
				if not Mission.JapAI.IgnoreHiryu then
					if not Mission.JapAI.Hiryu.Dead then
						if not Mission.JapAI.Hiryu.ToDepo then
-- RELEASE_LOGOFF  							luaLog("  Mission.JapAI.Hiryu.ToDepo -- Soryu")
							NavigatorMoveToPos(Mission.JapAI.Hiryu, {["x"] = 3094.9, ["y"] = 0, ["z"] = -1139.6})
							Mission.JapAI.Hiryu.ToDepo = true
						elseif not Mission.JapAI.Hiryu.Retreating then
							local hostileShips = luaGetShipsAroundCoordinate(GetPosition(Mission.JapAI.Hiryu), 15000, PARTY_JAPANESE, "enemy")
							local hostilePlanes = luaGetPlanesAroundCoordinate(GetPosition(Mission.JapAI.Hiryu), 15000, PARTY_JAPANESE, "enemy")
							local hostiles = luaGetHostiles(hostileShips, hostilePlanes)
							if hostiles > 2 then
-- RELEASE_LOGOFF  								luaLog("  Mission.JapAI.Hiryu.Retreating -- Soryu")
								NavigatorMoveToPos(Mission.JapAI.Hiryu, {["x"] = 9917.1, ["y"] = 0, ["z"] = -1422.6})
								Mission.JapAI.Hiryu.Retreating = true
							end
						end
					else
